  ...
  $('input[data-module="autocomplete"]')
    .on("change", function (e) {
      if (e.added) {
        ...
        var container = $(this).siblings(".rd-select2-tags-container");

        if (!container || container.length === 0) {
          $(this).after('<div class="rd-select2-tags-container"></div>');
          container = $(this).siblings(".rd-select2-tags-container");
        }
