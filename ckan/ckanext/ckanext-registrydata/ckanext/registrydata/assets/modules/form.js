 ...
 *   // <input name="example" data-module="registrydata_input_multiple" data-module-link-text="{{ _("Add link")}}" data-module-link-icon="false" />
 *
 */
ckan.module("registrydata_input_multiple", function ($) {
  return {
    options: {
      linktext: 'Add link',
      linkicon: 'fa-globe',
